...
public class RenderEngine {
   ...
   public int[] func_28149_a(String s) {
      ...
      if (ai != null) {
         ...
         try {
            ...
            int[] ai1 = this.func_28148_b(this.missingTextureImage);
   ...
   public void setupTexture(BufferedImage bufferedimage, int i) {
      ...
      if (useMipmaps && i != this.guiItemsTextureId) {
         ...
         if (GLContext.getCapabilities().OpenGL12) {
            ...
            GL11.glTexParameteri(3553, 33085, height);
         }
      } else {
   ...
   public void updateDynamicTextures() {
         ...
         if (!texturefx.getClass().getName().equals("ModTextureStatic") || !this.dynamicTexturesUpdated) {
            ...
            if (!customOk || this.imageData.limit() > 0) {
               ...
               if (this.imageData.limit() <= 0) {
                  ...
                  ix = tileWidth * tileHeight * 4;
                  if (texturefx.imageData.length == ix) {
                     this.imageData.clear();
               ...
               for(ix = 0; ix < texturefx.tileSize; ++ix) {
      ...
      for(i = 0; i < this.textureList.size(); ++i) {
         ...
         if (texturefx.textureId > 0) {
            ...
            this.imageData.put(texturefx.imageData);
            this.imageData.position(0).limit(texturefx.imageData.length);
            GL11.glBindTexture(3553, texturefx.textureId);
   ...
   public void refreshTextures() {
      ...
      while(iterator3.hasNext()) {
         ...
         bufferedimage2 = (BufferedImage)this.textureNameToImageMap.get(i);
         this.setupTexture(bufferedimage2, i);
      }
      ...
      while(iterator3.hasNext()) {
         ...
         try {
            ...
            this.func_28147_a(bufferedimage2, (int[])this.field_28151_c.get(s1));
            this.blurTexture = false;
            this.clampTexture = false;
         } catch (IOException var7) {
            var7.printStackTrace();
   ...
   public byte[] getCustomTextureData(String imagePath, int tileWidth) {
      byte[] imageBytes = (byte[])this.textureDataMap.get(imagePath);
      if (imageBytes == null) {
   ...
   public ResourceLocation getDynamicTextureLocation(String par1Str, DynamicTexture par2DynamicTexture) {
      Integer var3 = (Integer)this.field_28151_c.get(par1Str);
      if (var3 == null) {
         var3 = 1;
      } else {
         var3 = var3 + 1;
      ...
      this.field_28151_c.put(par1Str, var3);
   ...
   public boolean loadTexture(ResourceLocation par1ResourceLocation, ITextureObject par2TextureObject) {
      boolean var3 = true;
      ...
      try {
         ...
         this.textureMap.put(par1ResourceLocation, par2TextureObject2);
         var3 = false;
   ...
   public void bindTexture(ResourceLocation par1ResourceLocation) {
      Object var2 = (ITextureObject)this.textureMap.get(par1ResourceLocation);
      if (var2 == null) {
