   ...
   public void doExplosionA() {
            ...
            for(var5 = 0; var5 < var2; ++var5) {
               if (var3 == 0 || var3 == var2 - 1 || var4 == 0 || var4 == var2 - 1 || var5 == 0 || var5 == var2 - 1) {
                  ...
                  for(float var21 = 0.3F; var14 > 0.0F; var14 -= var21 * 0.75F) {
                     var22 = MathHelper.floor_double(var15);
                     var23 = MathHelper.floor_double(var17);
                     var24 = MathHelper.floor_double(var19);
      ...
      if (this.isFlaming) {
         for(int var34 = var32.size() - 1; var34 >= 0; --var34) {
            ...
            int var37 = var35.y;
            var22 = var35.z;
            var23 = this.worldObj.getBlockId(var36, var37, var22);
            var24 = this.worldObj.getBlockId(var36, var37 - 1, var22);
            if (var23 == 0 && Block.opaqueCubeLookup[var24] && this.ExplosionRNG.nextInt(3) == 0) {
               this.worldObj.setBlockWithNotify(var36, var37, var22, Block.fire.blockID);
            }
         }
      }
