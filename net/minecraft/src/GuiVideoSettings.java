...
public class GuiVideoSettings extends GuiScreen {
   ...
   public void initGui() {
      ...
      this.controlList.add(new GuiSmallButton(100, x, y, "Animations..."));
      x = this.width / 2 - 155 + 160;
      this.controlList.add(new GuiSmallButton(101, x, y, "Details..."));
      y += 21;
      x = this.width / 2 - 155 + 0;
      this.controlList.add(new GuiSmallButton(102, x, y, "World..."));
      x = this.width / 2 - 155 + 160;
      this.controlList.add(new GuiSmallButton(103, x, y, "Other..."));
         ...
         if (System.currentTimeMillis() >= this.mouseStillTime + (long)activateDelay) {
            ...
            if (btn != null) {
               ...
               for(int i = 0; i < lines.length; ++i) {
                  String line = lines[i];
                  this.fontRenderer.drawStringWithShadow(line, (double)(x1 + 5), (double)(y1 + 5 + i * 11), 14540253);
               }
            }
         }
      } else {
