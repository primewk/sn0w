      ...
      if (var2 >= this.top && var2 <= this.bottom) {
         ...
         if (var3 >= 0) {
            ...
            if (var5.length() > 0) {
               ...
               GuiStats.getFontRenderer9(this.statsGui).drawStringWithShadow(var5, (double)var6, (double)var7, -1);
            }
         }
      }
   ...
   protected void func_27267_a(StatCrafting var1, int var2, int var3) {
      if (var1 != null) {
         ...
         if (var5.length() > 0) {
            ...
            GuiStats.getFontRenderer11(this.statsGui).drawStringWithShadow(var5, (double)var6, (double)var7, -1);
         }
      }
