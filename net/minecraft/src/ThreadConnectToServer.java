...
class ThreadConnectToServer extends Thread {
   ...
   public void run() {
      try {
         ...
         NetClientHandler var10000 = GuiConnecting.getNetClientHandler(this.connectingGui);
         Session var10003 = this.mc.session;
         var10000.addToSendQueue(new Packet2Handshake(Session.username));
