...
public class BlockRedstoneRepeater extends Block {
   ...
   private boolean ignoreTick(World var1, int var2, int var3, int var4, int var5) {
      ...
      case 1:
         if (var1.isBlockIndirectlyProvidingPowerTo(var2 - 1, var3, var4, 4) || var1.getBlockId(var2 - 1, var3, var4) == Block.redstoneWire.blockID && var1.getBlockMetadata(var2 - 1, var3, var4) > 0) {
            return true;
         }

         return false;
      case 2:
         if (!var1.isBlockIndirectlyProvidingPowerTo(var2, var3, var4 - 1, 2) && (var1.getBlockId(var2, var3, var4 - 1) != Block.redstoneWire.blockID || var1.getBlockMetadata(var2, var3, var4 - 1) <= 0)) {
            return false;
         }

         return true;
      case 3:
         if (var1.isBlockIndirectlyProvidingPowerTo(var2 + 1, var3, var4, 5) || var1.getBlockId(var2 + 1, var3, var4) == Block.redstoneWire.blockID && var1.getBlockMetadata(var2 + 1, var3, var4) > 0) {
            return true;
         }
