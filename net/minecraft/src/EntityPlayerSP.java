...
import net.minecraft.src.MEDMEX.Event.EventType;
...
public class EntityPlayerSP extends EntityPlayer {
   ...
   public EntityPlayerSP(Minecraft var1, World var2, Session var3, int var4) {
      ...
      this.mc = var1;
      this.dimension = var4;
      if (var3 != null && Session.username != null && Session.username.length() > 0) {
   ...
   protected boolean pushOutOfBlocks(double var1, double var3, double var5) {
      if (!ViewClip.instance.isEnabled() && !Freecam.instance.isEnabled()) {
