...
public class Block {
   ...
   public boolean shouldSideBeRendered(IBlockAccess var1, int var2, int var3, int var4, int var5) {
      if (Xray.instance.isEnabled() && (this.blockID == 54 || this.blockID == 14 || this.blockID == 15 || this.blockID == 16 || this.blockID == 21 || this.blockID == 56 || this.blockID == 73 || this.blockID == 74 || this.blockID == 41 || this.blockID == 42 || this.blockID == 57 || this.blockID == 50 || this.blockID == 61 || this.blockID == 130 || this.blockID == 58 || this.blockID == 355 || this.blockID == 129 || this.blockID == 90)) {
         return true;
      } else if (var5 == 0 && this.minY > 0.0D) {
         return true;
   ...
   public int getBlockTexture(IBlockAccess var1, int var2, int var3, int var4, int var5) {
      if (Search.instance.isEnabled() && Search.blocks.contains(this.blockID)) {
         Search.searchx.add(var2);
         Search.searchy.add(var3);
         Search.searchz.add(var4);
      }
   ...
   public int getRenderBlockPass() {
      return Xray.instance.isEnabled() && this.blockID != 54 && this.blockID != 14 && this.blockID != 15 && this.blockID != 16 && this.blockID != 21 && this.blockID != 56 && this.blockID != 73 && this.blockID != 74 && this.blockID != 41 && this.blockID != 42 && this.blockID != 57 && this.blockID != 50 && this.blockID != 61 && this.blockID != 130 && this.blockID != 58 && this.blockID != 355 && this.blockID != 129 && this.blockID != 90 ? 1 : 0;
   }
