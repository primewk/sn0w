      ...
      if (!this.isDrawing) {
         ...
         if (!this.renderingChunk) {
            ...
            if (this.useVBO) {
               ...
               ARBVertexBufferObject.glBindBufferARB(35044, this.vertexBuffers.get(this.vboIndex));
               ARBVertexBufferObject.glBufferDataARB(35044, this.byteBuffer, 35040);
