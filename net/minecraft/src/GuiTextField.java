...
public class GuiTextField extends Gui {
   ...
   public void drawTextBox() {
      drawRect((double)(this.xPos - 1), (double)(this.yPos - 1), (double)(this.xPos + this.width + 1), (double)(this.yPos + this.height + 1), -6250336);
      drawRect((double)this.xPos, (double)this.yPos, (double)(this.xPos + this.width), (double)(this.yPos + this.height), -16777216);
      if (this.isEnabled) {
