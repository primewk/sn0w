...
final class J_ChainedFunctor implements J_Functor {
   ...
   public Object applyTo(Object var1) {
      ...
      try {
         ...
         throw J_JsonNodeDoesNotMatchChainedJsonNodeSelectorException.func_27321_b(var5, this.parentJsonNodeSelector);
      }

      try {
         Object var3 = this.childJsonNodeSelector.getValue(var2);
         return var3;
      } catch (J_JsonNodeDoesNotMatchChainedJsonNodeSelectorException var4) {
         throw J_JsonNodeDoesNotMatchChainedJsonNodeSelectorException.func_27323_a(var4, this.parentJsonNodeSelector);
      }
   }
