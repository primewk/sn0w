...
public class GuiAchievements extends GuiScreen {
   ...
   protected void drawTitle() {
      ...
      this.fontRenderer.drawString("Achievements", (double)(var1 + 15), (double)(var2 + 5), 4210752);
   }
   ...
   protected void drawAchievementScreen(int var1, int var2, float var3) {
      ...
      int var33;
      int var25;
      for(var16 = 0; var16 * 16 - var15 < 155; ++var16) {
         float var23 = 0.6F - (float)(var13 + var16) / 25.0F * 0.3F;
         GL11.glColor4f(var23, var23, var23, 1.0F);

         for(var33 = 0; var33 * 16 - var14 < 224; ++var33) {
            var21.setSeed((long)(1234 + var12 + var33));
            var21.nextInt();
            var25 = var21.nextInt(1 + var13 + var16) + (var13 + var16) / 2;
            int var26 = Block.sand.blockIndexInTexture;
            if (var25 <= 37 && var13 + var16 != 35) {
               if (var25 == 22) {
            ...
            this.drawTexturedModalRect(var10 + var33 * 16 - var14, var11 + var16 * 16 - var15, var26 % 16 << 4, var26 >> 4 << 4, 16, 16);
         }
      }
      ...
      for(var12 = 0; var12 < AchievementList.achievementList.size(); ++var12) {
         var27 = (Achievement)AchievementList.achievementList.get(var12);
         if (var27.parentAchievement != null) {
            var14 = var27.displayColumn * 24 - var4 + 11 + var10;
            var15 = var27.displayRow * 24 - var5 + 11 + var11;
            var16 = var27.parentAchievement.displayColumn * 24 - var4 + 11 + var10;
            var17 = var27.parentAchievement.displayRow * 24 - var5 + 11 + var11;
            boolean var18 = false;
            boolean var19 = this.statFileWriter.hasAchievementUnlocked(var27);
            boolean var20 = this.statFileWriter.canUnlockAchievement(var27);
            var25 = Math.sin((double)(System.currentTimeMillis() % 600L) / 600.0D * 3.141592653589793D * 2.0D) > 0.6D ? 255 : 130;
            if (var19) {
               var33 = -9408400;
            } else if (var20) {
               var33 = '\uff00' + (var25 << 24);
      ...
      if (var27 != null) {
         ...
         if (this.statFileWriter.canUnlockAchievement(var27)) {
            ...
            if (this.statFileWriter.hasAchievementUnlocked(var27)) {
               this.fontRenderer.drawStringWithShadow(StatCollector.translateToLocal("achievement.taken"), (double)var17, (double)(var33 + var37 + 4), -7302913);
            }
         } else {
            var34 = Math.max(this.fontRenderer.getStringWidth(var31), 120);
            String var39 = StatCollector.translateToLocalFormatted("achievement.requires", var27.parentAchievement.statName);
            var25 = this.fontRenderer.splitStringWidth(var39, var34);
            this.drawGradientRect(var17 - 3, var33 - 3, var17 + var34 + 3, var33 + var25 + 12 + 3, -1073741824, -1073741824);
            this.fontRenderer.drawSplitString(var39, var17, var33 + 12, var34, -9416624);
         }

         this.fontRenderer.drawStringWithShadow(var31, (double)var17, (double)var33, this.statFileWriter.canUnlockAchievement(var27) ? (var27.getSpecial() ? -128 : -1) : (var27.getSpecial() ? -8355776 : -8355712));
      }
