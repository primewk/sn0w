...
import net.minecraft.src.MEDMEX.ProtocolSelection.GuiProtocolSelection;
...
public class GuiMultiplayer extends GuiScreen {
   ...
   public void initGui() {
      ...
      this.controlList.add(new GuiButton(69, 4, 4, 100, 20, var1.translateKey("Protocol Version")));
   ...
   protected void actionPerformed(GuiButton var1) {
      if (var1.enabled) {
         if (var1.id == 1) {
            ...
            this.mc.displayGuiScreen(new GuiProtocolSelection(this));
         }
      }
