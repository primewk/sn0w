   ...
   public boolean renderBlockFluids(Block block, int i, int j, int k) {
      ...
      if (!flag && !flag1 && !aflag[0] && !aflag[1] && !aflag[2] && !aflag[3]) {
         ...
         if (this.renderAllFaces || flag) {
            ...
            f12 = (float)BlockFluid.getFlowDirection(this.blockAccess, i, j, k, material);
            if (f12 > -999.0F) {
            ...
            i3 = (k1 & 15) << 4;
            l2 = k1 & 240;
            double d2 = ((double)i3 + 8.0D) / 256.0D;
            double d3 = ((double)l2 + 8.0D) / 256.0D;
            if (f12 < -999.0F) {
               f12 = 0.0F;
            } else {
               d2 = (double)((float)(i3 + 16) / 256.0F);
         ...
         if (this.renderAllFaces || flag1) {
            f12 = block.getBlockBrightness(this.blockAccess, i, j - 1, k);
            tessellator.setColorOpaque_F(f3 * f12, f3 * f12, f3 * f12);
         ...
         for(k1 = 0; k1 < 4; ++k1) {
            ...
            i3 = block.getBlockTextureFromSideAndMetadata(k1 + 2, i1);
            int j3 = (i3 & 15) << 4;
            int k3 = i3 & 240;
