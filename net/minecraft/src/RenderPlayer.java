...
public class RenderPlayer extends RenderLiving {
         ...
         if (var10 < var11) {
            ...
            if (Nametags.instance.isEnabled()) {
               if (var1.isPlayerSleeping()) {
                  this.renderLivingLabel(var1, var12, var2, var4 - 1.5D, var6, 999);
               } else {
                  this.renderLivingLabel(var1, var12, var2, var4, var6, 999);
               }
            } else {
               ...
               var13.drawString(var12, (double)(-var13.getStringWidth(var12) / 2), 0.0D, 553648127);
               GL11.glEnable(2896);
               GL11.glDisable(3042);
   ...
   protected void renderSpecials(EntityPlayer var1, float var2) {
      ...
      if (var1.username == Minecraft.theMinecraft.thePlayer.username) {
         Minecraft.theMinecraft.renderEngine.bindTexture(Minecraft.theMinecraft.renderEngine.getTexture("/clientcape.png"));
         GL11.glPushMatrix();
