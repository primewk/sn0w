...
public class EntityRenderer {
   ...
   private float getFOVModifier(float f) {
      ...
      float f1 = this.mc.gameSettings.fov * 110.0F;
   ...
   private void setupFog(int i, float partialTicks) {
      ...
      if (this.cloudFog) {
         ...
         GL11.glFogf(2916, this.farPlaneDistance * fogEnd);
      }
