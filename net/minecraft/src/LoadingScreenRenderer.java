   ...
   public void setLoadingProgress(int var1) {
      if (!this.mc.running) {
         ...
         if (var2 - this.field_1006_d >= 20L) {
            ...
            this.mc.fontRenderer.drawStringWithShadow(this.currentlyDisplayedText, (double)((var5 - this.mc.fontRenderer.getStringWidth(this.currentlyDisplayedText)) / 2), (double)(var6 / 2 - 4 - 16), 16777215);
            this.mc.fontRenderer.drawStringWithShadow(this.field_1004_a, (double)((var5 - this.mc.fontRenderer.getStringWidth(this.field_1004_a)) / 2), (double)(var6 / 2 - 4 + 8), 16777215);
            Display.update();
